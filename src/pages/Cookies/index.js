    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="container mt-3 mb-3 justify-content">
                    <div className="row">
                        <div className="col-sm-12">
                         ...
                         <p>Hyde International (UK) Ltd. ("us", "we", or "our") uses cookies on Hyde International (UK) Website (the "Site"). By using the Site, you consent to the use of cookies.
              ...
              <p>When you use and access the Service, we may place a number of cookies files in your web browser.
