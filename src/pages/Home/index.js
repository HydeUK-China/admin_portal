...
export default class Home extends Component {
  ...
  receiveUpdateData() {
    fetchReq("/api/fetchProject/all")
      .then((data) => {
        console.log("fetchProjectAll", data);
        this.setState({
      ...
      <Fragment>
        ...
        <section id="featured">
          <div className="container-fluid ">
            ...
            <div className="featured-jobs_grid">{this.getProjectList()}</div>
            <div className="mt-3">
        ...
        <div className="whyUs_Container">
          ...
          <article>
            ...
            innovative platform for global talented individuals and
            organisations in scientific and technological fields to exchange
            knowledge, incubate their research ideas and source collaborative
            opportunities.
          </article>
