                ...
                <Grid container spacing={3} alignItems='center' justify='center'
                    ...
                    >
                        ...
                        <Grid item xs={12} sm={4} md={4} lg={4}  >
                            ...
                            <div className='footerCard'>
                                <h4>Help</h4>
                                <Link to="/cookies-policy" className='footerLink'> <ArrowForwardIosIcon />Cookies policy</Link>
                                <br />
                                <Link to="/terms-of-service" className='footerLink'><ArrowForwardIosIcon />Terms of service</Link>
                                <br />
                                <Link to="/privacy-policy" className='footerLink'><ArrowForwardIosIcon />Privacy policy</Link>
                            </div>
